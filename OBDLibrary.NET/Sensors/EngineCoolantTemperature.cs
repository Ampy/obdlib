...
{
    public class EngineCoolantTemperature : NumericSensor
    {
        private static EngineCoolantTemperature _instance;
        private static readonly object SyncLock = new object();

        private EngineCoolantTemperature()
        {
        }

        public static EngineCoolantTemperature GetInstance()
        {
            if (_instance == null)
            {
                lock (SyncLock)
                {
                    if (_instance == null)
                    {
                        ...
                        _instance = new EngineCoolantTemperature();
        ...
        {
            get { return "Engine coolant temperature (°C)"; }
        }
